...
if (isset($_POST['submit'])) {
    ...
    if ($issuccess) {
        ...
        sendemail::sendmail($email, 'School Registration System', 'You have login successfully');
?>

        <img src="<?php echo empty($destination) ? "uploads" : $destination; ?>" class="rounded-circle" style="width: 20%; height: 20%" />
