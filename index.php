...
<h1 class="text-center">School Registration</h1>
...
<form method="post" action="success.php" onsubmit="return validateForm()" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <label for="choice" class="form-label">Select Grade:</label>
    ...
    <div class="form-group">
        ...
        <div id="phoneHelp" class="form-text">We will never share your number with anyone else.</div>
    ...
    <button type="submit" name="submit" class="btn btn-warning btn-block mt-3">Submit</button>
